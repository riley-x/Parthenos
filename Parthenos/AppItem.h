...
enum class CTPMessage
{
	...
	MENUBAR_CALCHOLDINGS, MENUBAR_ACCOUNT, MENUBAR_ADDTRANSACTION, MENUBAR_PRINTTRANSACTIONS,
	MENUBAR_PRINTHOLDINGS, MENUBAR_PRINTEQHIST, MENUBAR_UPDATELASTEQHIST,
